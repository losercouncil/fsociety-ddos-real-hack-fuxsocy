...
def usage():
    print(logo)
    print(r"----------------------------------------------------------------------------------------------")
    print(r"XxxXxxXxXxXxXxxXxXxXxXxXxXxxXxxXxXxXXxXxXXxXxXxXXxXxXxXxXxXxXxXXxXXxXXxXXxXxxXXxXXxXXxXXxXXxXx")
    print(r"----------------------------------------------------------------------------------------------")
    print(r"author : losercouncil")
    print(r"usage: python loser.py <ur URL> ")
    print(r"example: python loser.py [http://www.example.com]")
...
def setup():
    ...
    if not match:
        print("url format incorrect make sure to do http instead of https")
        sys.exit(1)
    host = match.group(1)
